...
if __name__ == '__main__':
    # save_file2csv(r'E:\challenge\data\MM-WHS2017\trainstage\train', 'data/traindata.csv')
    # save_file2csv(r'E:\challenge\data\MM-WHS2017\trainstage\validation', 'data/validata.csv')
    save_file2csv(r'E:\challenge\data\MM-WHS2017\trainstage\augtrain', 'data/trainaugdata.csv')

    ## test
    # save_file2csv(r'E:\challenge\PytorchDeepLearing-main\lab\hellodata\autrain', 'E:/challenge/PytorchDeepLearing-main/lab/hellodata/data/autraindata.csv')
    # save_file2csv(r'E:\challenge\PytorchDeepLearing-main\lab\hellodata\val', 'E:/challenge/PytorchDeepLearing-main/lab/hellodata/data/validata.csv')